            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm">
                        <input id="menuSeries" name="menuSeries" type="hidden" value="${menu.menuSeries}"/>
                        <input id="menuId" name="menuId" type="hidden" value="${menu.menuId}"/>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">上级菜单：</label>
                            <div class="col-sm-8">
                                <input id="pname" name="pname" class="form-control" type="text" value="${pName}" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input id="menuIco" name="menuIco" class="form-control" type="text"
                                       placeholder="fa fa-circle-o" value="${menu.menuIco}">
                            </div>
...
<script src="../../../js/sys/menu/edit.js"></script>
<script>
    $(function () {
