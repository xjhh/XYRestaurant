                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="purchaseName" name="purchaseName" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">采购商品单价：</label>
                            <div class="col-sm-8">
                                <input id="purchasePrice" name="purchasePrice" oninput="clearNoNum(this)" value="0.0" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">采购商品数量：</label>
                            <div class="col-sm-8">
                                <input id="purchaseNumber" name="purchaseNumber" oninput="updateProductNumber()" value="1" class="form-control" type="number">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">采购地址：</label>
                            <div class="col-sm-8">
                                <input id="purchaseAddr" name="purchaseAddr" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">采购总价：</label>
                            <div class="col-sm-8">
                                <input id="purchaseTotal" name="purchaseTotal" class="form-control" value="0" type="text" readonly>
                            </div>
                        </div>
                        <input id="purchaseUser" name="purchaseUser" value="${user.managerId}" type="hidden" readonly>
                        <div class="form-group">
...
<script src="../../../js/purchase/add.js"></script>
<script>
    $(function () {
    });
