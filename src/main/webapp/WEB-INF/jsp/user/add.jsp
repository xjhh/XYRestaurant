                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="managerUsername" name="managerUsername" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">密码：</label>
                            <div class="col-sm-8">
                                <input id="managerPassword" type="managerPassword" name="managerPassword" class="form-control" >
                            </div>
                        </div>
                        <div class="form-group">
...
<script>
    $(function () {
        ...
        $("input[name='managerPower']").get(0).checked=true;
    })
</script>
</body>
</html>
